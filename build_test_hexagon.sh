...
export CARGO_TARGET_HEXAGON_UNKNOWN_LINUX_MUSL="qemu-hexagon -L /local/mnt/workspace/install/clang+llvm-18.1.2-cross-hexagon-unknown-linux-musl/x86_64-linux-gnu/target/hexagon-unknown-linux-musl/usr"
